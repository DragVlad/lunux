...
# Суть снапшота: при изменении оригинального тома старые данные копируются в снапшот, поэтому он занимает место только на разницу.
# Исходный том продолжает жить своей жизнью, а снапшот — это его замороженная копия на момент создания.